...
const LicensePhotoUpload = () => {
    ...
    const licensePhoto = useSelector((state) => state.images.licensePhoto);
    ...
    const { getRootProps, getInputProps } = useDropzone({
        ...
        onDrop: (acceptedFiles) => {
            ...
            dispatch(uploadImage({ file, type: "licensePhoto" }));
    ...
    return (
        ...
        >
            <input {...getInputProps()} />
            {licensePhoto ? (
                <img src={licensePhoto} alt="License" width="100%" style={{ borderRadius: 8 }} />
            ) : (
